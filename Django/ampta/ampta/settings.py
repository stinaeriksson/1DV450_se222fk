...
DATABASES = {
    'default': {
        ...
        'NAME': '/Users/stinaeriksson/1DV450_se222fk/Django/ampta/data.db',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '@u4(5kct5+25-a)b8w!g$#rxqsrqow=$-0bq_ga(u7m$(_fmzo'
